        ...
        <div className="container grid grid-cols-1 md:grid-cols-2 min-h-[650px] relative ">
            ...
            <div className=' flex flex-col justify-center py-14 md:py-0 relative z-10  '>
                <div className=' text-center md:text-left space-y-6 lg:max-w-[450px] '>
                    ...
                    <p className=' text-2xl tracking-wide   '>Order Now for Juicy Healthy Delight</p>
            ...
            <div className=' flex justify-center items-center  '>
                <img src={Heropng} alt="Hero image"  className=' w-[350px] md:w-[550px] drop-shadow '/>
            </div>
            {/* Leaf image */}
            <div  className=' absolute top-14 md:top-0 right-1/2 blur-sm opacity-80 rotate-[40deg] '>
                <img src={leaf} alt="" className=' w-full md:w-[300px]  ' />
            </div>
        </div>
